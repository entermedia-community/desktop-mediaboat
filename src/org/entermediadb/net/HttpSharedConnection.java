...
//	}
	...
	public JSONObject parseJson(CloseableHttpResponse resp) 
	{
		try {
			...
			if (resp.getStatusLine().getStatusCode() != 200)
			{
				...
				throw new RuntimeException("HTTP Error:" + resp.getStatusLine().getStatusCode() + ":" + resp.getStatusLine().getReasonPhrase() + " Body: \n" + returned);
				//throw new RuntimeException("Could not process " + returned);
			}
	...
	{
			HttpPost method = new HttpPost(UrlEscape.urlEscape(path));
